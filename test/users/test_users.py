...
from common.exceptions import Unauthorised, ServerErrorException, NotFoundException, NotValidPermissions, BadRequest
from ..common.fixtures import mock_response, mock_bad_response_with_status, fake_broker

sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../app')))
from users.users import get_users, create_user, AUTOGENERATED, delete_user, add_permissions, delete_permissions, \
